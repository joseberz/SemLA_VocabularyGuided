...
__all__ = ["MaskFormerSemanticDatasetMapperVal"]


class MaskFormerSemanticDatasetMapperVal:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        """
        assert not self.is_train, "MaskFormerSemanticDatasetMapperVal should only be used for inference!"
