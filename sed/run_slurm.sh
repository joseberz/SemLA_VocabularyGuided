...
#SBATCH -o /leonardo_scratch/fast/EUHPC_D11_069/repos/SED/output/sed_train_slurm_out.txt
#SBATCH -e /leonardo_scratch/fast/EUHPC_D11_069/repos/SED/output/sed_train_slurm_error.txt
#SBATCH --time 20:00:00     # format: HH:MM:SS
#SBATCH -N 1                # 1 node
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --gres=gpu:1        # 4 gpus per node out of 4
#SBATCH --mem=40000         # memory per node out of 494000MB (481GB)
