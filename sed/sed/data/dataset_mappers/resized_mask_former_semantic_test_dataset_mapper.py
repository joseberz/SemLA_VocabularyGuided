...
class ResizedMaskFormerSemanticTestDatasetMapper(DatasetMapper):
    ...
    # TODO: check if disabled augmentations give better result    
    # def __init__(self, cfg, is_train=False):
    #     """
    #     Initializes the dataset mapper. For evaluation, is_train is set to False.
    #     """
    #     # Dataset mapper without any augmentations
    #     augmentations = [] 
    #     super().__init__(
    #         is_train=is_train,
