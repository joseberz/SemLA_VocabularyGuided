...
RAINY_CITYSCAPES_100MM_SPLITS = {
    "cs-rain-100mm_{task}_train": ("weather_datasets/weather_cityscapes/leftImg8bit/train/rain/100mm/rainy_image/",
                                    "cityscapes/gtFine/train/"),
    "cs-rain-100mm_{task}_val": ("weather_datasets/weather_cityscapes/leftImg8bit/val/rain/100mm/rainy_image/",
                                    "cityscapes/gtFine/val/"),
}

def register_rainy_cityscapes_100mm(root):
    for key, (image_dir, gt_dir) in RAINY_CITYSCAPES_100MM_SPLITS.items():
...
register_rainy_cityscapes_100mm(_root)