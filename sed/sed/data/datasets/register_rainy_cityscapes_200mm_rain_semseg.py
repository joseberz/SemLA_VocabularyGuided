...
RAINY_CITYSCAPES_200MM_SPLITS = {
    "cs-rain-200mm_{task}_train": ("weather_datasets/weather_cityscapes/leftImg8bit/train/rain/200mm/rainy_image/",
                                    "cityscapes/gtFine/train/"),
    "cs-rain-200mm_{task}_val": ("weather_datasets/weather_cityscapes/leftImg8bit/val/rain/200mm/rainy_image/",
                                    "cityscapes/gtFine/val/"),
}

def register_rainy_cityscapes_200mm(root):
    for key, (image_dir, gt_dir) in RAINY_CITYSCAPES_200MM_SPLITS.items():
...
register_rainy_cityscapes_200mm(_root)