...
RAINY_CITYSCAPES_25MM_SPLITS = {
    "cs-rain-25mm_{task}_train": ("weather_datasets/weather_cityscapes/leftImg8bit/train/rain/25mm/rainy_image/",
                                    "cityscapes/gtFine/train/"),
    "cs-rain-25mm_{task}_val": ("weather_datasets/weather_cityscapes/leftImg8bit/val/rain/25mm/rainy_image/",
                                    "cityscapes/gtFine/val/"),
}

def register_rainy_cityscapes_25mm(root):
    for key, (image_dir, gt_dir) in RAINY_CITYSCAPES_25MM_SPLITS.items():
...
register_rainy_cityscapes_25mm(_root)