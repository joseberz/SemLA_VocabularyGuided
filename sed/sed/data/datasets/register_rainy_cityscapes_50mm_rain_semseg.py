...
RAINY_CITYSCAPES_50MM_SPLITS = {
    "cs-rain-50mm_{task}_train": ("weather_datasets/weather_cityscapes/leftImg8bit/train/rain/50mm/rainy_image/",
                                    "cityscapes/gtFine/train/"),
    "cs-rain-50mm_{task}_val": ("weather_datasets/weather_cityscapes/leftImg8bit/val/rain/50mm/rainy_image/",
                                    "cityscapes/gtFine/val/"),
}

def register_rainy_cityscapes_50mm(root):
    for key, (image_dir, gt_dir) in RAINY_CITYSCAPES_50MM_SPLITS.items():
...
register_rainy_cityscapes_50mm(_root)