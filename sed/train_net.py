...
def set_random_seed(seed=0, deterministic=True):
    #from https://github.com/MarcBotet/hamlet/blob/4c9b8db6712b2e4680f40ac4d8b3f653cd77d641/mmseg/apis/train.py#L24
    """Set random seed.
...
def main(args):
    ...
    wandb.init(mode="offline", sync_tensorboard=True, name= cfg.MODEL.LORA.NAME) # uncomment for logging to wandb
    ...
    if cfg.MODEL.LORA.ENABLED:
        ...
        # Attaching LoRAs changes the modules to which hooks are set
        trainer.model.print_trainable_parameters()
    else:
        for name, param in trainer.model.sem_seg_head.predictor.clip_model.named_parameters():
